...
class FinetuningModelGenerator(ModelGenerator):
    ...
    def __init__(self, pretraining_model_generator, output_spec=None, pretraining_model_manipulation_function = None, dropout_rate = 0.5, optimizer_class = None, \
    ...
    def create_model(self, seq_len, freeze_pretrained_layers = False):
        ...
        model = keras.models.Model(inputs = model_inputs, outputs = [pretraining_output_seq_layer, pretraining_output_annoatations_layer])
        self._init_weights(model)
