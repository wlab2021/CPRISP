...
def ANF_NCP_EIIP_Onehot_Encoding(sampleSeq3DArr):
    ...
    for sequence in sampleSeq3DArr:
        ...
        for j in range(len(sequenceStr)):
            ...
            if (thisLetter == "A"):
                probMatr[sampleNo][AANo][0] = 1      # ring structure
                probMatr[sampleNo][AANo][1] = 1      # Chemical properties
                probMatr[sampleNo][AANo][2] = 1      # hydrogen bond
                probMatr[sampleNo][AANo][3] = 0.126  # EIIP
                # Base types
            ...
            probMatr[sampleNo][AANo][8] = sequenceStr[0: j + 1].count(sequenceStr[j]) / float(j + 1)  # ANF
